...
<div class="photo_header"><img src="{$data.photo_header}.jpg" width="180" height="120" alt=""></div>
   ...
   {if $row_cate}
    ...
    <dd>
     <ul class="clearfix">
      ...
      <li>
       <div><a href="detail.php?id={$row.id}&car=sp"><img src="{$row.photo_header}.jpg" width="70" height="46" alt=""></a></div>
       <p><a href="detail.php?id={$row.id}&car=sp">{$row.kansou_mark}{$row.age}歳 {$row.sex}{$row.sex_ex}</a></p>
      </li>
       {/foreach}
     </ul>
    </dd>
